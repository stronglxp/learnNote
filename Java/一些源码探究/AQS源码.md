...
![image-20211118220304798](AQS源码.assets/image-20211118220304798.png)

同步队列设置尾结点的过程大致如下

![image-20211118220603314](AQS源码.assets/image-20211118220603314.png)

同步队列的首节点是获取锁成功的线程，首节点的线程在释放锁后，将会唤醒后继节点，后继节点如果获取锁成功的同时会把自己设置为头结点

![image-20211118220813981](AQS源码.assets/image-20211118220813981.png)
...
![image-20211120111207936](AQS源码.assets/image-20211120111207936.png)

独占式同步状态获取流程，也就是acquire(int arg)方法调用流程大致如下

![image-20211120111407345](AQS源码.assets/image-20211120111407345.png)
